...
#SBATCH --qos=normal
#SBATCH -J object_both
#SBATCH --nodes=1
#SBATCH -c 8
#SBATCH --time=4320000
#SBATCH --chdir=/public/home/lingwang/lmj/UniPre3D
#SBATCH --output=/public/home/lingwang/lmj/UniPre3D/logs/object_level/both/%x_%j.out
#SBATCH --error=/public/home/lingwang/lmj/UniPre3D/logs/object_level/both/%x_%j.err
#SBATCH --gres=gpu:1
